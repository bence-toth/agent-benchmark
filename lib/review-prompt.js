...
## Response format
Use the Write tool to save your scores to \`.review-scores.json\` with this structure:
\`\`\`json
{
  "scores": {
    "<axis>": { "score": 0-100 or null, "rationale": "one sentence" }
  }
}
\`\`\`

You may explain your reasoning before or after writing the file.`
}
