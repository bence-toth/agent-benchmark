...
export function branchName(id, variantKey) {
  return `${BRANCH_PREFIX}/${id}/${variantKey}`
}

export async function createWorktree(repoPath, id, variantKey) {
...
export async function pushBranch(repoPath, id, variantKey) {
  const branch = branchName(id, variantKey)
